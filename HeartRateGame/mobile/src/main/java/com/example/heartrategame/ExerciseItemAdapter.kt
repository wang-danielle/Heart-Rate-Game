...
class ExerciseItemAdapter(val context: Context, val exercises: List<Pair<Exercise, Long>>): RecyclerView.Adapter<ExerciseItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.sideText.text = formatTime(exercise.second)
